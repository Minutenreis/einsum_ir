...
with open(filename, "r") as f:
    ...
    for i in {2,4,8,16,32,64, 96,128, 180, 256}:
        ...
        gflops = sortedArrayByGflops[5][1]
        gflops_10 = sortedArrayByGflops[1][1]
        gflops_90 = sortedArrayByGflops[9][1]
        # gflops_mpi = sum([x[2] for x in sortedArrayByGflopsMPI]) / 100
        gflops_mpi = sortedArrayByGflopsMPI[5][2]
        gflops_mpi_10 = sortedArrayByGflopsMPI[1][2]
        gflops_mpi_90 = sortedArrayByGflopsMPI[9][2]
        speedup = sortedArrayBySpeedup[5][3]
        speedup_10 = sortedArrayBySpeedup[1][3]
        speedup_90 = sortedArrayBySpeedup[9][3]
